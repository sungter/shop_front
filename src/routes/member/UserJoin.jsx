...
const UserJoin = () => {
  ...
  const insertValidate = () => {
    ...
    setErrorMsg((state) => {
      return { ...state, userId: "", userPw: "", userName: "", userTel: "" };
    });
      ...
      <div className={styles.body}>
        <table>
          <tbody>
            <tr>
              <td>
                아이디 <span className={styles.red}>*</span>
              </td>
              <td>
                <ShopInput
                  maxLength={16}
                ...
                />
                <span className={styles.check_data}>
                  {" "}
                  영문 대,소문자 4~16자
                </span>
            ...
            <tr>
              <td>
                이름 <span className={styles.red}>*</span>
              </td>
              <td>
                <ShopInput
                  maxLength={16}
                ...
                <span className={styles.check_data}>
                  {" "}
                  영문 대,소문자 혹은 한글 2~16자
                </span>
                {errorMsg.userName && (
                  <p className="error-msg">{errorMsg.userName}</p>
                )}
              </td>
            </tr>
            ...
            <tr>
              <td>
                전화번호<span className={styles.red}>*</span>
              </td>
              <td>
                <ShopInput
                  maxLength={3}
